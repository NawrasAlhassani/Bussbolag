...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 05 jun 2016 kl 01:12
...
--
ALTER TABLE `resenar`
  MODIFY `ResenarID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tur`
  MODIFY `ReseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
